...
const CATEGORY_HELP_TEXTS = {
  ...
  "خمن اللاعب (فرق فقط)": "يختار أحد أفراد الفريق لاعباً ليرى اسم اللاعب قبل اختيار السؤال، ثم يحاول باقي الفريق تخمينه خلال 60 ثانية فقط عبر طرح أسئلة لا تكون إجابتها إلا بنعم أو لا.",
  ...
  "اسم الإصابة من الأشعة": "تُعرض صورة أشعة أو لقطة طبية، وعليك تحديد الإصابة الصحيحة.",
};
